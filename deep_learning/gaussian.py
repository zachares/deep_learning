...
def logprobs(means: torch.Tensor, precs: torch.Tensor, samples: torch.Tensor) -> torch.Tensor:
...
def negative_log_likelihood(params: Tuple[torch.Tensor], samples: torch.Tensor) -> torch.Tensor:
...
def divergence_KL(params0: Tuple[torch.Tensor], params1: Tuple[torch.Tensor]) -> torch.Tensor:
...
def sample(means: torch.Tensor, precs: torch.Tensor, device: torch.device) -> torch.Tensor:
