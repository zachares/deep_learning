...
from cifar_10_dataset.load_cifar_10 import load_cifar_10_data
import deep_learning.multinomial as multinomial
from deep_learning.model_manager.model_utils import init_and_load_models
from example_code.example_training.example_models import ModelFactory
...
def testing_example():
    ...
    print("\nThe classification accuracy of your model was " +
         f"{class_acc.mean().item()} on the CIFAR-10 train set.")
    ...
    print("The classification accuracy of your model was " +
          f"{class_acc.mean().item()} on the CIFAR-10 val set.")
