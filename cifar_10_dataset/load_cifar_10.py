...
"""
THIS CODE WAS TAKEN DIRECTLY FROM A PUBLIC REPOSITORY ON GITHUB 
-> https://github.com/snatch59/load-cifar-10 AND MODIFIED SLIGHTLY 
(uncommented line 35 and modified the function to return a list of strings with the 
name of each class, labelled the types of the functions inputs and outpouts). 
...
def load_cifar_10_data(data_dir : str, negatives=False) -> Tuple[np.ndarray]:
    """
    ...
    return cifar_train_data, cifar_train_filenames, cifar_train_labels, \
        cifar_test_data, cifar_test_filenames, cifar_test_labels, label_names
